...
lines = [
    ...
    "- Successful workflow run (green): https://github.com/Mhmdwael77/GAN/actions/runs/23101916292",
    "- Screenshot note: Capture the Actions tab green run and attach it to the submission.",
    "",
